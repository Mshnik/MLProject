...
We will use existing linear classification software.
 ...
 Once we determine how to classify the projects then we can investigate different binary classification approaches to compare for both efficiency and accuracy.
